...
const questions: QuestionConfig[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'other', label: 'Other (e.g., qualitative research, bioinformatics, survey design)' },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'other', label: 'Other (e.g., urgent care, telehealth, mental health facility)' },
    ],
  },
  {
  ...
  },
  {
    ...
    label: 'If certified or planning to get certified, how many hours per week are you working (or do you plan to work) in that clinical role?',
    type: 'select',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'other', label: 'Other (e.g., language skills, global health experience)' },
    ],
  },
  {
    id: 'mcat_confidence',
  ...
  {
    id: 'service_nature',
    label: 'How would you describe the nature of your service and volunteer work?',
    type: 'select',
    options: [
      { value: '', label: 'Select the nature of your service' },
      { value: 'deep-relationships', label: 'Deep relationships with individuals (e.g., mentoring, advocacy, tutoring the same people over time)' },
      { value: 'direct-service-many', label: 'Direct service to many people (e.g., food bank, health fairs, large-scale events)' },
      { value: 'behind-scenes', label: 'Behind-the-scenes or organizational work (e.g., fundraising, administration, program development)' },
      { value: 'mixed', label: 'Mix of direct service and relationship-building' },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'other', label: 'Other (e.g., global health, technology/innovation, entrepreneurship)' },
    ],
  },
  {
    id: 'target_cycle',
